...
class cloud_descr_from_file:
    def __init__(self, cloudfilename, default_param_obj):
        ...
        if cloudfilename is None:
            ...
            config_dict = {}
            inp_spec.copy_to_config_dict(
                config_dict, "additional_cloud_parameters", default_param_obj
            )
            ...
            cloud_params = inp_spec.import_module_from_file(
                "additional_cloud_parameters", cloudfilename
            )

            # Verify validity of provided module w.r.t. parameters_dict
            inp_spec.assert_module_has_parameters(
                cloud_params, "additional_cloud_parameters"
            )
