...
parameters_dict = {
    "superparameters": {
        "pi"
    },  # are allowed anywhere and can be repeated (for backwards compatibility)
    ...
    "machine_parameters": {
        ...
        "optional": {
            ...
            "B": 0.0,  # Tesla (if B=-1 computed from energy and bending radius)
            "bm_totlen": -1,  # m
            "B_map_file": None,
...
for key in (
    ...
    parameters_dict["combined_simulations_secondaryEmission_machine_parameters"][
        "mandatory"
    ].update(parameters_dict[key]["mandatory"])
    parameters_dict["combined_simulations_secondaryEmission_machine_parameters"][
        "optional"
    ].update(parameters_dict[key]["optional"])
