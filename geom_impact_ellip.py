...
class ellip_cham_geom_object:
    ...
    def impact_point_and_normal(
        ...
        t0 = (
            ...
            + sqrt(
                a ** 4 * b ** 2 * y_insq
                - 2 * a ** 4 * b ** 2 * y_in__y_out
                + a ** 4 * b ** 2 * y_outsq
                + a ** 2 * b ** 4 * x_insq
                - 2 * a ** 2 * b ** 4 * x_in__x_out
                + a ** 2 * b ** 4 * x_outsq
                - a ** 2 * b ** 2 * x_insq * y_outsq
                + 2 * a ** 2 * b ** 2 * x_in__x_out * y_in__y_out
                - a ** 2 * b ** 2 * x_outsq * y_insq
            )
            + b ** 2 * x_insq
            - b ** 2 * x_in__x_out
        ) / (
        ...
        flag_ident = (
            ((x_in - x_out) * (x_in - x_out) + (y_in - y_out) * (y_in - y_out))
